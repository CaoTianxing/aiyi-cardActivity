...
<script>
  ...
  export default {
    ...
    created(){
      ...
      // this.shareData = {
      //   "isShare":true,
      //   "img": "https://img.artmkt.cn/1539164165747.jpg",    // 分享显示的缩略图地址
      //   "url": "http://m.app.artmkt.com/#/taoxichuan",    // 分享地址
      //   "summary": "为摊主打call，获取支付宝现金￥5.00元红包！",   // 分享描述
      //   "title": "为你最喜爱的创艺活动打Call",   // 分享标题
      //   "thumbImg": "https://img.artmkt.cn/1539164165747.jpg",
      //   "miniId": null,
      //   "miniPath": null
      // }
      // try {
      //   if (this.browser.versions.ios) {
      //     window.open("initShare(" + JSON.stringify(this.shareData) + ")")
      //   } else if (this.browser.versions.android) {
      //     app.initShare(JSON.stringify(this.shareData));
      //   }
      // }catch (e) {
      //
      // }
            ...
            .then((res) => {
              ...
              if (res.data.errcode === '00000') {
                ...
                for (var j = 0;j<ulList.length;j++){
                  ulList[this.getUrlData - 1].children[0].style.backgroundColor = '#ff9966'
    ...
    .content{
      ...
      .rule{
        ...
        span{
          ...
          display: block;
          float: right;
          background: url("../../assets/images/CollectingCards/xiaobaiqianjin2x.png") no-repeat center;
          -webkit-background-size: cover;
          background-size: cover;
          margin-top: 2/100rem;
